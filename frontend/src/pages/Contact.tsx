                    ...
                    >
                        ...
                        <form className="space-y-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <select className="w-full px-6 py-4 bg-slate-50 border border-slate-200 rounded-2xl focus:outline-none focus:ring-2 focus:ring-[#B31212]/20 focus:border-[#B31212] transition-all text-slate-900 appearance-none">
                            ...
                            <Button className="w-full py-5 text-xl bg-[#B31212] hover:bg-[#8B0000] text-white rounded-2xl shadow-xl hover:shadow-2xl hover:scale-[1.02] transition-all flex items-center justify-center gap-3">
